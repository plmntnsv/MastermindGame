...
3. Fresher UI with some animations for example  
4. Reset/ClearAll button to remove already typed letters  
5. Convenient left and right buttons to switch boxes  
6. Start button to start the game instead of it auto starting  
7. More than 4 letters secrets - it is kinda there but the UI needs to support it  
8. Difficulty select - include small letters, numbers  
9. Retry counter  
10. Points  

Thank you for this task and I hope you like it!
